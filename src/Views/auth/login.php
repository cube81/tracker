        ...
        <div class="auth-login-body">
            <?php if ($error): ?>
                <div class="error-message">
                    ...
                    <?php if ($submittedEmail): ?>
                        <br><a href="/reset-password?email=<?= urlencode($submittedEmail) ?>" style="color: #c0392b; text-decoration: underline;">Przypomnieć hasło</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" class="auth-login-form">
                <div class="form-group">
                    ...
                    <input type="email" id="email" name="email" placeholder="your@email.com" value="<?= htmlspecialchars($submittedEmail ?? '') ?>" required autofocus>
                </div>
